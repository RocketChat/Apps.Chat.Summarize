export const WELCOME_MESSAGE = `🌟 Rocket.Chat AI Chat Summarizer
Say goodbye to endless scrolling through messages! 📑
The AI Chat Summarizer quickly turns messages in channels, DMs, and threads into clear, concise summaries — boosting productivity 🚀 and saving you time ⏱️.
`;

export const FREQUENTLY_ASKED_QUESTIONS = `📜 Frequently Asked Questions (FAQs) 📜
...
*A*: If you find this app useful, please leave a ⭐️ star on the GitHub repository. Your support helps more people discover and benefit from this project!
`;
